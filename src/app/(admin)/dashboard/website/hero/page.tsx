        ...
        <div style={{ display: 'grid', gap: '16px' }}>
          {heroSlides.length === 0 ? (
            ...
            heroSlides.map((slide, index) => (
              <div key={slide.id} className="admin-card" style={{ display: 'grid', gridTemplateColumns: '150px 1fr auto', gap: '16px', alignItems: 'center', opacity: slide.isActive ? 1 : 0.6 }}>
                {/* Preview Image */}
