  ...
  return (
    <div className={styles.authContainer}>
      <div className={styles.authCard}>
        <h1 className={styles.title}>{language === "ar" ? "تسجيل الدخول" : "Login"}</h1>
        <p className={styles.subtitle}>{language === "ar" ? "مرحباً بك مجدداً في تمارا" : "Welcome back to Tamara"}</p>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <button type="submit" className={styles.submitBtn} disabled={loading}>
            {loading ? (language === "ar" ? "جاري الدخول..." : "Logging in...") : (language === "ar" ? "تسجيل الدخول" : "Login")}
          </button>
        </form>
